  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Braunschweig | Magic Mirror</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Magic Mirror in Braunschweig für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Magic Mirror | Premium Barbershop Braunschweig" />
        <meta
        ...
        <meta name="twitter:title" content="Magic Mirror | Premium Barbershop Braunschweig" />
        <meta
